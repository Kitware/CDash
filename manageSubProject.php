...
<html lang="en" ng-app="CDash" ng-controller="ManageSubProjectController">
  <head>
    <meta charset="UTF-8">
    ...
    <script src="javascript/tooltip.js"></script> <!-- TODO: replace with bootstrap -->
      ...
      <div role="tabpanel" ng-if="cdash.projectid > -1">
        ...
        <div class="tab-content">
          ...
          <div role="tabpanel" class="tab-pane active container" id="current">
            ...
            <div ng-controller="SubProjectController" ng-repeat="subproject in cdash.subprojects | orderBy:'name' | filter_groups:cdash.filteredGroup" class="repeat-item">
              <div class="row">
                <div class="col-md-4">
                ...
                <div class="row">
                  ...
                  <div class="col-md-3" ng-if="cdash.groups.length > 0">
                    <div class="form-inline">
                      ...
                      <img id="group_changed_{{details.subprojectid}}" src="images/check.gif" style="display: none; height:16px; width=16px; margin-top:9px;" />
                    </div>
                  </div>
          ...
          <div role="tabpanel" class="tab-pane container" id="add">
            ...
            <div class="col-md-9 form-horizontal">
              ...
              <img id="subproject_created" src="images/check.gif" style="display: none; height:16px; width=16px; margin-top:9px;" />
            </div>
          </div> <!-- "add" pane -->
                ...
                <table class="table table-striped">
                  ...
                  <tbody>
                    <tr class="form-group repeat-item" ng-repeat="group in cdash.groups | orderBy:'name'">
                      ...
                      <td class="col-md-1">
                        <input type="radio" name="groupRadio" ng-model="cdash.default_group_id" value="{{group.id}}">
                      </td>
                      ...
                      <td class="col-md-1">
                        <img id="group_updated_{{group.id}}" src="images/check.gif" style="display: none; height:16px; width=16px; margin-top:9px;" />
                      </td>
                      <td class="col-md-1">
