                ...
                <tr>
                  ...
                  <td>
                    ...
                    >
                      ...
                      <option
                        value="1"
                        v-if="cdash.user.admin || cdash.max_project_visibility === 'PUBLIC'"
                      >
                        Public
                      </option>
                      <option
                        value="2"
                        v-if="cdash.user.admin || cdash.max_project_visibility === 'PUBLIC' || cdash.max_project_visibility === 'PROTECTED'"
                      >
                        Protected
                      </option>
                    </select>
