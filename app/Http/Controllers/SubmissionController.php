...
final class SubmissionController extends AbstractProjectController
{
    ...
    private function submitProcess(): Response
    {
        ...
        if (isset($handler->schema_file) && !file_exists(base_path().$handler->schema_file)) {
            throw new CDashXMLValidationException(["ERROR: Could not find schema file '{$handler->schema_file}'"
