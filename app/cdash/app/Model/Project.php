...
class Project
{
    ...
    public function Save(): bool
    {
        ...
        $project->fill([
            ...
            'emaillowcoverage' => filter_var($this->EmailLowCoverage, FILTER_VALIDATE_BOOLEAN),
            'emailtesttimingchanged' => filter_var($this->EmailTestTimingChanged, FILTER_VALIDATE_BOOLEAN),
            ...
            'showtesttime' => filter_var($this->ShowTestTime, FILTER_VALIDATE_BOOLEAN),
