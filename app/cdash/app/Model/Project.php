...
class Project
{
    ...
    public function Save(): bool
    {
        ...
        $project->fill([
            ...
            'emailbrokensubmission' => (bool) $this->EmailBrokenSubmission,
            'emailredundantfailures' => (bool) $this->EmailRedundantFailures,
            'displaylabels' => (bool) $this->DisplayLabels,
            'sharelabelfilters' => (bool) $this->ShareLabelFilters,
            'viewsubprojectslink' => (bool) $this->ViewSubProjectsLink,
            'authenticatesubmissions' => (bool) $this->AuthenticateSubmissions,
            'showcoveragecode' => (bool) $this->ShowCoverageCode,
    ...
    public function Fill(): void
    {
        ...
        if ($project !== null) {
            ...
            $this->EmailLowCoverage = (int) $project->emaillowcoverage;
            $this->EmailTestTimingChanged = (int) $project->emailtesttimingchanged;
