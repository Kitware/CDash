...
function upgrade_0_8() {
  const text = 'Applying 0.8 patches';
...
function upgrade_1_0() {
  const text = 'Applying 1.0 patches';
...
function upgrade_1_2() {
  const text = 'Applying 1.2 patches';
...
function upgrade_1_4() {
  const text = 'Applying 1.4 patches';
...
function upgrade_1_6() {
  const text = 'Applying 1.6 patches';
...
function upgrade_1_8() {
  const text = 'Applying 1.8 patches';
...
function upgrade_2_0() {
  const text = 'Applying 2.0 patches';
...
function upgrade_2_2() {
  const text = 'Applying 2.2 patches';
...
function upgrade_2_4() {
  const text = 'Applying 2.4 patches';
...
function upgrade_2_6() {
  const text = 'Applying 2.6 patches';
...
function upgrade_2_8() {
  const text = 'Applying 2.8 patches';
...
function upgrade_3_0() {
  const text = 'Applying 3.0 patches';
