...
class IssueCreationTestCase extends KWWebTestCase
{
    ...
    public function testIssueCreation(): void
    {
        ...
        pdo_execute($test_stmt, [$buildid1, 'itkVectorLevelSetFunctionTest2']);
