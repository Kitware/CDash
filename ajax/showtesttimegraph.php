...
$previousbuilds = mysql_query("SELECT build.id,build.starttime,build2test.time FROM build,build2test WHERE siteid='$siteid' AND type='$buildtype' AND name='$buildname'
