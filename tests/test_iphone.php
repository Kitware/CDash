...
class iPhoneTestCase extends KWWebTestCase
{
    ...
    public function testiPhone()
    {
        ...
        $this->get($this->url."/mobile/buildsummary.php?buildid=1");
