...
describe('EditProject', function() {
  ...
  it('handles new project API response', async function() {
    this.axios.onGet('/api/v1/createProject.php').reply(200, this.new_response);
    component = mount(EditProject, { localVue } );
  ...
  it('handles edit project API response', async function() {
    this.axios.onGet('/api/v1/createProject.php?projectid=999999999').reply(200, this.edit_response);
    component = mount(EditProject, { localVue, propsData: { projectid: 999999999 } } );
    await component.vm.$nextTick();
    await component.vm.$nextTick();
    await component.vm.$nextTick();
    await component.vm.$nextTick();
