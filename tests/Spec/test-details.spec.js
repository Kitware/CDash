...
describe('TestDetails', function() {
  ...
  it('handles API response', async function() {
    this.axios.onGet('/api/v1/testDetails.php?buildtestid=').reply(200, this.api_response);
  ...
  it('can toggle the graphs', async function() {
    ...
    this.axios.onGet('/api/v1/testGraph.php?testid=1&buildid=1&type=time').reply(200, this.graph_data);
  ...
  it('can load the graphs by default', async function() {
    ...
    this.axios.onGet('/api/v1/testDetails.php?buildtestid=&graph=time').reply(200, this.api_response);
    this.axios.onGet('/api/v1/testGraph.php?testid=1&buildid=1&type=time').reply(200, this.graph_data);
    component = mount(TestDetails);
    await component.vm.$nextTick();
    await component.vm.$nextTick();
