...
$fixes = $summary['fixes'];
?>
Congratulations. A submission to CDash for the project {{ $summary['project_name'] }} has fixed {{ $desciptions }}. You have been identified as one of the authors who have checked in changes that are part of this submission or you are listed in the default contact list.
...
Test failures: {{ $fixes['TestFailure']['failed']['fixed'] }}
@endif
