  ...
  $Build, $Project, $prefix = 'none')
{
  ...
  foreach ($errors as $errorkey => $nerrors) {
      ...
      switch ($errorkey) {
        case 'update_errors': if (!check_email_category("update", $useremailcategory)) {
     $stop=true;
 } break;
        case 'configure_errors': if (!check_email_category("configure", $useremailcategory)) {
     $stop=true;
 } break;
        case 'build_errors': if (!check_email_category("error", $useremailcategory)) {
     $stop=true;
 } break;
        case 'build_warnings': if (!check_email_category("warning", $useremailcategory)) {
     $stop=true;
 } break;
        case 'test_errors': if (!check_email_category("test", $useremailcategory)) {
     $stop=true;
 } break;
        case 'dynamicanalysis_errors': if (!check_email_category("dynamicanalysis", $useremailcategory)) {
     $stop=true;
 } break;
        }
      } else {
